...
function MensClothing() {
   let[mensClothingProducts ,setMensClothingProducts ] = useState([]);

   useEffect(()=>{

       mensClothingService().then((response)=>{
           console.log(response.data);
           setMensClothingProducts(response.data);
       }).catch((error)=>{
           console.log(error);
       })
   },[])
  ...
  return (
    <div>
        <Header></Header>
        {
            mensClothingProducts.length>0 ? <div className='flex flex-wrap justify-evenly items-center'>
                {mensClothingProducts.map((element)=>{
                    // return <div>
