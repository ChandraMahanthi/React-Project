    ...
    <div>
        {
            electronicProducts.length>0 ? <div className='flex flex-wrap justify-evenly items-center'>
                {electronicProducts.map((element)=>{
                    ...
                    //     <h3>{element.price}</h3>
                    // </div>
                    return <div class="w-full h-140 max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-500 transition-all duration-1000">
    <a href="#">
