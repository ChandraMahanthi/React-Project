  ...
  <div class="container mx-auto px-4 py-8">
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-4 mb-8">
        <img src={responseData.image} alt="Product"
                    class="w-full h-auto rounded-lg shadow-md mb-4" id="mainImage"/>
        <div class="flex gap-4 py-4 justify-center overflow-x-auto">
          <img src={responseData.image} alt="Thumbnail 1"
      ...
      <div class="w-full md:w-1/2 px-4">
        <h2 class="text-3xl font-bold mb-2">{responseData.title}</h2>
        <p class="text-gray-600 mb-4">SKU: WH1000XM4</p>
        <div class="mb-4">
          <span class="text-2xl font-bold mr-2">&#36;{responseData.price}</span>
        ...
        <div class="flex items-center mb-4">
          ...
          <span class="ml-2 text-gray-600">{responseData.rating.rate} ({responseData.rating.count} reviews)</span>
        </div>
        <p class="text-gray-700 mb-6">{responseData.description}</p>
        <div class="mb-6">
